...
<head>
    ...
    <title>Invoice | The Book Stack</title>
                        ...
                        <div class="col-6">
                            <div class="row">
                                ...
                                <div class="col-12 fw-bold text-end">
                                    <span>Ahangama, Galle, Sri Lanka</span><br />
                                    <span>+94 76 608 8374</span><br />
                                    <span>thebookstack@gmail.com</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 mb-4">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    ?>
                                    <h2><?php echo ($_SESSION["cust"]["fname"] . " " . $_SESSION["cust"]["lname"]); ?></h2>
                                ...
                                <div class="col-6 text-end mt-4">
                                    <h5 class="text-primary">INVOICE 0<?php echo ($invoice_data["id"]); ?></h5>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr style="height: 72px;">
                                        ...
                                        <td class="fs-6 fw-bold text-end pt-4 bg-secondary text-white">Rs. <?php echo ($product_data["price"]) ?> .00</td>
                                        <td class="fs-6 fw-bold text-end pt-4"><?php echo ($invoice_data["qty"]) ?></td>
                                        <td class="fs-6 fw-bold text-end pt-4 bg-secondary text-white">Rs. <?php echo ($invoice_data["total"]) ?> .00</td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <?php
